...
class SeleccionarHabitosFragment : Fragment() {
    ...
    private var maxHabitosPermitidos = 2 // Por defecto, máximo 2 hábitos
    ...
    override fun onCreateView(
        ...
        // Obtener los hábitos registrados y el máximo permitido
        ...
        siguienteButton.setOnClickListener {
            ...
            // Validar si el usuario ya ha registrado el máximo de hábitos
            if (registeredHabits.size >= MAX_HABITS) {
                ...
                siguienteButton.isEnabled = false // Deshabilitar el botón si ya están todos registrados
            }
            // Validar que el usuario seleccione al menos 2 hábitos en total
            ...
            // Validar que el usuario no supere el máximo de 4 hábitos en total
            ...
            // Validar que no se seleccionen más de los permitidos en esta ronda
            ...
            // Pasar al fragmento de confirmación si todo es válido
            else {
                // Definir una fecha de inicio por defecto (hoy)
